...
const Navigation: React.FC = () => {
  ...
  const handleKeyDown = (e: KeyboardEvent<HTMLAnchorElement>, index: number): void => {
    let newIndex = index;
  ...
  useEffect(() => {
    ...
    const handleClickOutside = (e: MouseEvent | Event): void => {
      ...
      if (target.closest('.menu-toggle') || target.closest('.navigation-menu')) {
        return;
      }
    ...
    const handleEscape = (e: KeyboardEvent | Event): void => {
